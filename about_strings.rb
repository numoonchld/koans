...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # http://library.edgecase.com/a-little-more-about-strings

    #  Even though the result of the following 2 lines of code is the same, the approach that the Ruby interpreter takes is different. 
    ...
    # AS USUAL - SOMETHING TO DO WITH MEMORY MANAGEMENT AND SPEED/PERFORMANCE WHEN DEALING WITH LARGE SCALE ITERATIONS
