...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # THINK ABOUT IT:
    #
    # When would * fail to match? - last character after the previous character has been found
  end
  ...
  # Greedy RegEx: https://www.regular-expressions.info/repeat.html
  # Greedy regex operations return the result that has most characters when multiple solutions exists. 
