...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # roughly simimar to javscript accumulator/reduce function, if I understand correctly
  ...
  #   # code to read 'file'
  #   to prevent loading file into a variable; instead, it was directly read from the file
  #
